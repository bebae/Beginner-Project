...
--publisher 출판사 연락처 업데이트 
UPDATE publisher
SET phone_num = '0507-123-45' || id;

--member 테이블 회원ID, 이름, 비밀번호, 생년월일, 연락처, 이메일, 주소, 대출권수
INSERT
    into member(m_id, name, password, birth_date, phone_num, email, address, loans_num)
    values ('chopper', '김정환', 'Aabcd123!', '860925', '010-1234-5678', 'rudwlsab@naver.com', '대전 중구 선화동 523-2', 2);
INSERT
    into member(m_id, name, password, birth_date, phone_num, email, address, loans_num)
    values ('minjun1', '김민준', 'Aabcdef75', '000725', '010-4567-5823', 'jinja@gmail.com', '대전 서구 갈마동 302-5', 5);
INSERT
    into member(m_id, name, password, birth_date, phone_num, email, address, loans_num)
    values ('jinwoo5', '최진우', 'Bdjkl123!', '981212', '010-5691-2856', 'jinwoo3@naver.com', '대전 동구 낭월동 123-12', 3);
INSERT
    into member(m_id, name, password, birth_date, phone_num, email, address, loans_num)
    values ('dongjin2', '이동진', 'Ekdos45*', '010823', '010-5896-4794', 'dongjin45@gmail.com', '대전 중구 은행동 125-8', 2);
INSERT
    into member(m_id, name, password, birth_date, phone_num, email, address, loans_num)
    values ('seoyean1', '민서연', 'Homeonly12', '020615', '010-2598-8531', 'runat12@naver.com', '대전 대덕구 오정동 56-8', 10);
INSERT
    into member(m_id, name, password, birth_date, phone_num, email, address, loans_num)
    values ('Dongwoon', '한동운', 'Conenum**', '040823', '010-1258-7845', 'conwoon12@naver.com', '대전 유성구 구암동 458-12', 15);
INSERT
    into member(m_id, name, password, birth_date, phone_num, email, address, loans_num)
    values ('minye59', '이민영', 'Vdouell^', '970501', '010-1245-0589', 'roomdo@gmail.com', '대전 중구 산성동 408-18', 7);
INSERT
    into member(m_id, name, password, birth_date, phone_num, email, address, loans_num)
    values ('hyunwo7', '최현우', 'Riddo7*', '950523', '010-1025-0156', 'ginmol@naver.com', '대전 중구 오류동 12-8', 19);
INSERT
    into member(m_id, name, password, birth_date, phone_num, email, address, loans_num)
    values ('hyeonm8', '박현민', 'Oidsu7', '010101', '010-3658-4486', 'kingak4@naver.com', '대전 서구 도마동 25-6', 9);
INSERT
    into member(m_id, name, password, birth_date, phone_num, email, address, loans_num)
    values ('sora123', '김소라', 'Eebuk^9', '960812', '010-2589-4120', 'kiokuk99@gmail.com', '대전 서구 관저동', 5);
